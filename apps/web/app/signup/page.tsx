    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-6">
      <div className="w-full max-w-md bg-white rounded-3xl border border-gray-100 p-10 shadow-xl shadow-gray-200/50">
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight">Join AI Tutor</h1>
          <p className="text-gray-500 mt-2">Start your personalized learning journey today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            disabled={loading}
            className="w-full py-4 mt-2 bg-primary-600 text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-primary-700 transition-all shadow-lg shadow-primary-200 active:scale-[0.98] disabled:opacity-50"
          >
